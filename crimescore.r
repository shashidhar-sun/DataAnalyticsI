...
setwd("/Users/brennon/Desktop/crimescore/")
start.time=Sys.time()
...
instring='38.8325192140698,-76.9936390021642,38.90398,-77.05510'
test=Predict.CrimeScore.Vec(instring)
print(instring)
print(test)
